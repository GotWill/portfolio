            ...
            <div className="mt-8 flex justify-center items-center flex-wrap gap-5">

                {
                    itemsSkilTec.map((skil) => {
                        console.log(skil.bg)
                        return (
                            <div key={skil.id} className="w-48 h-40 px-3 bg-secondary rounded-3xl flex justify-center items-center flex-col gap-4  overflow-hidden text-white relative">

                                <div className="z-10">
                                    {skil.imagePath}
                                </div>

                                <h4 className="text-base font-bold z-10">{skil.title}</h4>
